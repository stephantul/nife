...
from scripts.infer_datasets import (
...
@patch("scripts.infer_datasets.load_dataset", side_effect=mock_load_dataset)
...
@patch("scripts.infer_datasets.get_all_datasets", create=True)
