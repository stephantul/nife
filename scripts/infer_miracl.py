...
if __name__ == "__main__":
    ...
    name = "sentence-transformers/miracl"
    folder_name = f"output/miracl_{model_name.replace('/', '__')}{suffix}"
    converted_folder_name = f"converted/miracl_{model_name.replace('/', '__')}{suffix}"
