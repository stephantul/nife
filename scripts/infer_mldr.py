...
if __name__ == "__main__":
    ...
    name = "sentence-transformers/mldr"
    folder_name = f"output/mldr_{model_name.replace('/', '__')}{suffix}"
    converted_folder_name = f"converted/mldr_{model_name.replace('/', '__')}{suffix}"
