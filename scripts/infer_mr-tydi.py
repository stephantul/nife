...
if __name__ == "__main__":
    ...
    name = "sentence-transformers/mr-tydi"
    folder_name = f"output/mr-tydi_{model_name.replace('/', '__')}{suffix}"
    converted_folder_name = f"converted/mr-tydi_{model_name.replace('/', '__')}{suffix}"

    dataset = cast(Dataset, load_dataset(name, "en-triplet", split="train"))
